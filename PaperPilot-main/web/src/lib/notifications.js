...
export function loadNotifications(uid) {
  try {
...
export function saveNotifications(items, uid) {
  try {
...
/** Group notifications into Today / Yesterday / Earlier for the activity feed. */
